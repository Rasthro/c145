...
label_id = Label(root , text = "1234567890")
label_name = Label(root , text="Rasthro .R. Rotha")
label_dob = Label(root , text="22/1/2009")
label_pin = Label(root , text="123456")
label_address = Label(root , text="Downtown, Greenfield, Canada")
...
button1 = Button(root , text="Show my license")
